...
document.getElementById('loveButton').addEventListener('click', function() {
    ...
    // Añadir clase de animación para la explosión
    button.classList.add('explode-animation');
    
    // Mostrar mensaje después de la animación
    setTimeout(function() {
        alert("AAAAH AMAS A UN TONTO");
        
        // Opcional: Reiniciar el botón después de la explosión
        button.classList.remove('explode-animation');
